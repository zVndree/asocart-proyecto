...
$(".tablaSubCategorias tbody").on("click", ".btnEditarSubCategoria", function(){
	...
	$.ajax({
		...
		success: function(respuesta){
			...
			$("#modalEditarSubCategoria .tituloSubCategoria").val(respuesta[0]["nombre"]);
			...
			if(respuesta[0]["id_categoria"] != 0){
				...
				$.ajax({
						...
						success: function(respuesta){
							...
							$("#modalEditarSubCategoria .optionEditarCategoria").html(respuesta["nombre"]);
						}
			...
			if(respuesta[0]["oferta"] != 0){
				...
				$("#modalEditarSubCategoria #precioOferta").val(maskDinero(respuesta[0]["precioOferta"]));
...
$(".tablaSubCategorias").on("click", ".btnEliminarSubCategoria", function () {
	...
	swal({
		title: '¿Está seguro de borrar la subcategoría '+ nombreSubCategoria +'?',
