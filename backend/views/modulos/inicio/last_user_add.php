...
$usuarios = ControllerUsuarios::ctrMostrarTotalUsuarios("fecha");
...
<div class="box box-danger">
        ...
        <ul class="users-list clearfix">
            ...
            for ($i = 0; $i < $totalUsuarios; $i++) {
                ...
                if ($usuarios[$i]["foto"] != "") {
                    ...
                    echo ' <li>
                <img src="views/img/usuarios/default/default.png" alt="User Image" style="width:100px;">
                <a class="users-list-name" href="#">' . $usuarios[$i]["nombre"] . '</a>
                <span class="users-list-date">' . $usuarios[$i]["fecha"] . '</span>
                </li>';
                }
    ...
    <div class="box-footer text-center">
        ...
        <a href="clientes" class="uppercase">Ver todos los usuarios</a>
