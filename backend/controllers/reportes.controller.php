        ...
        if (isset($_GET["reporte"])) {
            ...
            if ($_GET["reporte"] == "compras") {
                ...
                foreach ($reporte as $key => $value) {
                    ...
                    $traerProducto = ControllerProductos::ctrMostrarProductos($item, $valor);
                    ...
                    $traerCliente = ControllerUsuarios::ctrMostrarUsuarios($item2, $valor2);
            ...
            if ($_GET["reporte"] == "clientes") {
                ...
                =============================================*/
                    ...
                    echo utf8_decode($estado . "</td><td style='border:1px solid #eee;'>" . $value["fecha"] . "</td>
