 ...
 */
            ...
            $productos = controladorProductos::ctr_mostrar_all_productos($ordenar,$item2, $valor2, $base, $tope, $modo,);
            $list_products = controladorProductos::ctr_listar_all_productos($ordenar, $item2, $valor2);

            $total_productos = count($list_products);
